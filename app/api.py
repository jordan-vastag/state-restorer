...
class BoardState(BaseModel):
    ...
    move: Optional[Tuple[Optional[int], Optional[int]]]  # Tuple for the move (row, column)
...
def generate_next_board_state(board: List[List[str]], move: Tuple[int, int]) -> List[List[str]]:
    row, col = move
